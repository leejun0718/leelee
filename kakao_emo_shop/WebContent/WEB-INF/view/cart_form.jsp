...
<%
	ArrayList<Emo> emoList = (ArrayList<Emo>)request.getAttribute("emoList");
%>
<!DOCTYPE html>
<head>
...
<table style="center: 100px" border=0 width=100% height=376
								...
								<tr width=100%>
									...
									<!-- <a href="cart_delete_action.do">X</a> -->
									<td width=40% height=200 align=center><img border=0
										src="images/<%=emoList.get(i).getEmo_no() %>.gif" width=120 height=200></td>
									<td width=30% height=200 class=t1>
										<ol type="disc">
											<li><b><%=emoList.get(i).getEmo_name() %></b></li>
											<li><font color=#FF0000>가격 :
													<%=emoList.get(i).getEmo_price() %>&nbsp;&nbsp;&nbsp;</font></li>
			...
			<table style=100px border=0 width=100% height=376 align="center">
								<tr>
									<td align=center>
										<a href = "emo_buy_form.do">구매</a>
										<a href = "emo_main.do">계속쇼핑</a>
									</td>
								</tr>
							</table></td>
