...
<body class="animsition">
					...
					<div class="menu-desktop">
						<ul class="main-menu">
							...
							<li class=" #nav_hot"><a href="home_emo_famous.jsp"
								class="link_gnb link_gnb3"><b><u>스타일</u></b><span class="animate_line"></span></a></li>
					...
					<!-- 로그인 -->
          			 <a href="login.jsp">Log In  </a>
							...
							<div class="flex-c-m h-full p-l-18 p-r-25 bor5">
								...
								class="link_gnb link_gnb3"><b><u>Cart</u></b><span class="animate_line"></span></a></li>
								</div>
							</div>
	...
	<section class="sec-product bg0 p-t-100 p-b-50">
		<div class="container">
			<div class="p-b-32">
				<h3 class="ltext-105 cl5 txt-center respon1">스타일</h3>
			</div>
			...
			<div id="cMain" align="center" class="emoticon_main">
					<h2 id="dkBody" class="tit_comm tit_notice">귀요미</h2>
									...
									<table align="center" border="0" cellspacing="0"
										...
										<tr>
											...
											<td align="center" width="40%"><a
												href="product-detail.jsp"><img
													src="images/귀여운/마쉬는꿍싯미으리는통싯/마쉬는꿍싯미으리는통싯1.gif" width="150"
													height="150" border="0" align="center"></a><br /> <br />
												<b>마뮈무미미미"</b><br> <font color="#FF0000">가격:2500원
											</font></td>
											<td align="center" width="40%"><a
												href="product-detail.jsp"><img
													src="images/귀여운/마쉬는꿍싯미으리는통싯/마쉬는꿍싯미으리는통싯1.gif" width="150"
							...
							<div id="dkFoot" class="footer_comm " role="contentinfo">
								<div class="inner_footer">
									...
									<em class="emph_info">카카오 이모티콘 스토어에서 판매되는 콘텐츠의 저작권은 제공처에
										있으며, 이를 무단 이용하는 경우 저작권법 등에 따라 처벌될 수 있습니다.<br> 상호: 주식회사
										카카오, <span class="txt_leader">대표자: 여민수, 조수용,</span> <span
