...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%
	Emo emo = (Emo) request.getAttribute("emo");
%>
<!DOCTYPE html>
<html lang="en">
<head>
...
<script type="text/javascript">
	function button1_click() {
		alert("이모티콘을 구매합니다.");
		document.f.action = 'buy_cart_action.do';
	...
	function button2_click() {
		alert("장바구니에 추가합니다");
		document.f.action = 'cart_add_action.do';
		document.f.method = 'post';
		document.f.submit();
	}
</script>
...
<body class="animsition">
			...
			<div class="wrap-menu-desktop">
				...
				<nav class="limiter-menu-desktop p-l-45">
					...
					<div class="wrap-icon-header flex-w flex-r-m h-full">
						...
						%>
						<a href="user_modify_form.do">Log out</a>
						<%
							}
						%>
	...
	<div id="cMain" align="center" class="emoticon_main">
		...
		<form name="f" method="post">
			<input type="hidden" name="p_no" value="<%=emo.getEmo_no()%>">
			<td align="center" width="65%"><a href="#"><img
					src="images/<%=emo.getEmo_no()%>.gif" width="250" align="center"></a><b><%=emo.getEmo_name()%></b>
				<font color="#FF0000">&nbsp; 가격:<%=emo.getEmo_price()%>원
			</font></td>
			<br> <br> <font color="#FF0000">&nbsp; &nbsp; 사용기간</font>
			<tr>
				<font color="#FF0000">무제한</font>
				<div class="wrap_btn">
					<button class="btn btn-warning" type="button" value="구매하기"
						onClick="button1_click();">구매하기</button>
					&nbsp;&nbsp;
					<button class="btn btn-warning" type="button" value="장바구니"
						onClick="button2_click();">장바구니</button>
			</tr>
	...
	<div id="cMain" align="center" class="emoticon_main">
		...
		<td align="center" width="40%"><a href="#"><img
				src="images/<%=emo.getEmo_no()%>-1.png" width="1200" height="750"
				border="0" align="center"></a><br /> <br /></td>
