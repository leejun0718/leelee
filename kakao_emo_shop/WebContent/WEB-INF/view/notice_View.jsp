...
<%
	...
	Notice noticeView = (Notice)request.getAttribute("notice");
%>
<!DOCTYPE html>
<html lang="en">
<head>
		...
		<div id="mArticle">
			...
			<div class="section_cont notice_detail">
				<div class="tit_detail">
					<h3 class="tit_board"><%=noticeView.getBoard_title()%></h3>
				</div>
				<div class="desc_notice">
						<br>		
					<p><%=noticeView.getBoard_content() %>
					<p>
						<br>
					</p>
				</div>
			...
			<div class="paging_comm2">
				<!-- <span class="inner_paging"> <span class="ico_comm link_prev">이전</span> -->
					<a href="notice_list.do" class="link_list">목록</a> 
				</span>
			</div>
		</div>
		...
		<div class="container">
			...
			<div id="dkFoot" class="footer_comm " role="contentinfo">
				<div class="inner_footer">
					...
					<address class="txt_address">호스팅제공자: (주)카카오, 주소 : 제주특별자치도
						제주시 첨단로 242(영평동), 고객센터 : 1577-3754</address>
					<small class="txt_copyright"><a
						href="https://www.kakaocorp.com" target="_blank" class="link_info">©
							kakao Corp.</a></small>
