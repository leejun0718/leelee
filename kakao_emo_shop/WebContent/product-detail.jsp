...
<h2 id="dkBody" class="tit_comm tit_notice"></h2>
			...
			<form name="f" method="post">
				...
				<td align="center" width="65%"><a href="#"><img
						src="images/<%=emo.getEmo_no()%>.gif" width="250"
						align="center"></a><b><%=emo.getEmo_name() %></b> <font color="#FF0000">&nbsp; 가격:<%=emo.getEmo_price()%>원</font>
						</td><br> <br>
				<font color="#FF0000">&nbsp; &nbsp; 사용기간</font>
				<tr>
					<font color="#FF0000">무제한</font>
					<div class="wrap_btn">
		<button  class="btn_g btn_gift" type="button" value="구매하기"
	...
	<td align="center" width="40%"><a href="#"><img
			src="images/<%=emo.getEmo_no()%>-1.png" width="1000"
