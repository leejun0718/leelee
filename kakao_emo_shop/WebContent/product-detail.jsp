...
function product-buycart(){
	document.f.action='product-buycart.jsp';
			...
			<div class="wrap-menu-desktop">
				...
				<nav class="limiter-menu-desktop p-l-45">
					...
					<div class="menu-desktop">
						<ul class="main-menu">
							<li class="on #nav_home"><a href="home_main.jsp"
								class="link_gnb link_gnb1">홈<span class="animate_line"></span></a></li>
							<li class=" #nav_new"><a href="home_emo_new.jsp"
								class="link_gnb link_gnb2">신규<span class="animate_line"></span></a></li>
							<li class=" #nav_hot"><a href="home_emo_famous.jsp"
								class="link_gnb link_gnb3"><b><u>인기</u></b><span
					...
					<div class="wrap-icon-header flex-w flex-r-m h-full">
						...
						<div class="flex-c-m h-full p-l-18 p-r-25 bor5">
							<li class=" #nav_hot"><a href="shoping-cart.jsp"
...
<h2 id="dkBody" class="tit_comm tit_notice"></h2>
			...
			<form name="f" method="post">
				...
				<td align="center" width="65%"><a href="#"><img
						src="images/귀여운/마쉬는꿍싯미으리는통싯/마쉬는꿍싯미으리는통싯1.gif" width="250"
						align="center"></a><b>마뮈무미미미</b> <font color="#FF0000">&nbsp; 가격:2200원
				</font></td><br> <br>
				<font color="#FF0000">&nbsp; &nbsp; 사용기간</font>
				<tr>
					<font color="#FF0000">무제한</font>
					<div class="wrap_btn">
		<button  class="btn_g btn_gift" type=submit value="구매하기"
										onClick="login();">
								구매하기
							</button>
		<button  class="btn_g btn_gift"type=submit value="구매하기"
										onClick="product-buycart();">
								&nbsp; &nbsp; 장바구니
							</button>
				</tr>
	...
	<td align="center" width="40%"><a href="#"><img
			src="images/귀여운/마쉬는꿍싯미으리는통싯/마쉬는꿍싯미으리는퉁싯2.png" width="1000"
			height="1000" border="0" align="center"></a><br /> <br /></td>
				...
				<div id="dkFoot" class="footer_comm " role="contentinfo">
					<div class="inner_footer">
						...
						<div class="footer_link">
							...
							<span class="txt_bar">|</span> <a
								href="https://cs.kakao.com/requests?category=278&amp;locale=ko&amp;node=30555&amp;service=94"
								target="_blank" class="link_info">문의하기</a> <span class="txt_bar">|</span>
							<a href="https://web.payments.kakao.com/v1/service_terms"
						...
						<em class="emph_info">카카오 이모티콘 스토어에서 판매되는 콘텐츠의 저작권은 제공처에 있으며,
							이를 무단 이용하는 경우 저작권법 등에 따라 처벌될 수 있습니다.<br> 상호: 주식회사 카카오, <span
							class="txt_leader">대표자: 여민수, 조수용,</span> <span class="txt_num">사업자등록번호:
								120-81-47521,</span> <a href="#none" target="blank"
