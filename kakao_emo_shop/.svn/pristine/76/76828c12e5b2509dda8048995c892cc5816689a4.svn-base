					...
					<div class="menu-desktop">
						<ul class="main-menu">
							...
							<li class=" #nav_hot"><a href="home_emo_famous.jsp"
								class="link_gnb link_gnb3">인기<span class="animate_line"></span></a></li>
					</div>
...
<table style="center: 100px" border=0 width=100% height=376
								align=center>
								<tr valign=bottom>
									<td width=30% align=center class=t1><font size=2
										color=#0000FF><b>주문하기</b></font></td>
									<td width=40% align=center class=t1><font size=2
										color=#0000FF><b>이모티콘</b></font></td>
									<td width=30% align="left" class=t1><font size=2
										color=#0000FF><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;정보</b></font></td>
								</tr>
								<tr width=100%>
								...
								<tr width=100%>
									<td width=30% height=200 align=center class=t1>
										<form method="post" action="shop_add_cart.jsp">
											수량 : <input s type="text" name=qty value=1 size=4 class=TXTFLD>
											개 <br /> <br /> <input type=submit value=장바구니에담기
									...
									<td width=40% height=200 align=center><img border=0
										src=images/귀여운/마쉬는꿍싯미으리는통싯/마쉬는꿍싯미으리는통싯1.gif width=120 height=200></td>
			...
			<table style=100px border=0 width=100% height=376 align="center">
								<tr>
									<td align=center>
										<input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text" name="board_title" placeholder="#" style="width:10%; display: block; float:center">
										<button type=submit value="submit" value="구매" onClick="buy()" style="width:50%; display: block; float:right; background-color:#fff;">구매</button> &nbsp;
										<button type=submit value="submit"value="계속쇼핑" onClick="productList();"  style="width:50%; display: block; float:right; background-color:#fff;">계속쇼핑</button>
									</td>
								</tr>
							</table></td>
