...
<%
	ArrayList<Emo> emoList = (ArrayList<Emo>)session.getAttribute("emoList");
%>
<!DOCTYPE html>
<head>
...
<table style="center: 100px" border=0 width=100% height=376
			...
			<table style=100px border=0 width=100% height=376 align="center">
								<tr>
									<td align=center>
										<input type="image" value="이미지" style="width:10%; display: block; float:center">
										<input type="button" value="구매" onClick="buy()" style="width:50%; display: block; float:right; background-color:#fff;"> &nbsp;
										<input type="button" value="계속쇼핑" onClick="productList();" style="width:50%; display: block; float:right; background-color:#fff;">
									</td>
								</tr>
							</table></td>
