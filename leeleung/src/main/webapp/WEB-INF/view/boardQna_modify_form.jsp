...
<script type="text/javascript">
	...
	function boardqna_modify_action() {
		document.form.action = "boardQna_modify_action.do";
							...
							<table class="board" border="1">
					            ...
					            <tbody style="border: solid 1px #b2b2b2;">
					                <tr>
					                    ...
					                    <td>
					                    	<input type=hidden name="qnaInquiry" value="${boardQna.qnaInquiry}"/>
					                    	${boardQna.qnaInquiry}
					                    </td>
					                </tr>
					                ...
					                <tr>
					                    ...
					                    <td>
					                    	<input type=hidden name="qnaWriter" value="${boardQna.qnaWriter}"/>
					                    	${boardQna.qnaWriter}
					                    </td>
					                    <th scope="row">
					                    	날짜
					                ...
					                <tr>
					                    ...
					                    <td colspan="3" style="text-align: left;">&nbsp;&nbsp;
					                    	<input type="hidden" name="qnaTitle" value="${boardQna.qnaTitle}"/>
					                    	${boardQna.qnaTitle}
					                    </td>
					                </tr>
					                ...
					                <tr>
					                    ...
					                    <td colspan="3" style="height: 300px;text-align: left;"> &nbsp;&nbsp;
					                        <textarea rows="20" cols="160" name="qnaContent">
												${boardQna.qnaContent}
											</textarea>
					                    </td>
					                </tr>
								...
								<tr align=center>
									<td align=center colspan="2">
										<div style="text-align: center;padding-bottom: 15px;">
				    						<input type="submit" value="수정완료" onclick="boardqna_modify_action();" />
				    						<input type="button" value="목록으로" onclick="boardQnaList();" />
										</div>
									</td>
								</tr>
						</table>
