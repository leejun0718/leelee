...
<script type="text/javascript">
	function boardnnotice_insert_action() {

		document.form.action = 'boardNotice_insert_action.do';
								...
								<tbody style="border: solid 1px #b2b2b2">
									...
									<tr>
					                    ...
					                    <td colspan="3" style="text-align: left;">&nbsp;&nbsp;
					                    	<input type="text" style="width:600px;" name="noticewriter"/>
					                    </td>
					                </tr>
									...
									<tr>
					                    ...
					                    <td colspan="3" style="text-align: left;">&nbsp;&nbsp;
					                    	<input type="text" style="width:600px;" name="noticetitle"/>
					                    </td>
					                </tr>
								...
								<tr align=center>
									<td align=center colspan="2">
										<div style="text-align: center; padding-bottom: 15px;">
											<input type="submit" value="글쓰기" style="margin-right: 3px;" onclick="boardnnotice_insert_action();" />
