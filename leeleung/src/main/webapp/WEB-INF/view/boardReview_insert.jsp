...
<script type="text/javascript">
	function board_review_insert_action() {
		document.form.action = 'board_review_insert_action.do';
	...
	function boardReviewList() {
		document.form.action = 'boardReviewlist.do';
		document.form.submit();
	}
	
	function upload(){
		document.form.action = 'upload.do';
		document.form.method = 'POST';
		document.form.submit();
	}
</script>
		...
		<section class="two-columns-section standard-grid-section section-box">
			<div class="container">
				<div class="two-columns-content">
					...
					<div class="row">
						<h3
							style="width: 100%; text-align: center; padding: 20px 0 40px 0;">상품 후기</h3>
								...
								<tbody style="border: solid 1px #b2b2b2">
									...
									<tr>
					                    ...
					                    <td colspan="3" style="text-align: left;">&nbsp;&nbsp;
					                    	<input type="text" style="width:600px;" name="reviewWriter"/>
					                    </td>
					                </tr>
									...
									<tr>
					                    ...
					                    <td colspan="3" style="text-align: left;">&nbsp;&nbsp;
					                    	<input type="text" style="width:600px;" name="reviewTitle"/>
					                    </td>
					                </tr>
					                <tr>
					                	<th scope="row">
					                	...
					                	<td>
					                	 <input type="radio" name="reviewGrade" value="★★★★★" class="noline" checked="checked">★★★★★
					                ...
					                <tr>
					                    ...
					                    <td colspan="3" style="text-align: left;">&nbsp;&nbsp;
					                    	<input type="file" style="width:600px;" name="file"/>
    										<input type="button" value="제출" onclick="upload();"/>
					                    </td>
					                </tr>
									<tr>
										<th scope="row">내용</th>
								...
								<tr align=center>
									<td align=center colspan="2">
										<div style="text-align: center; padding-bottom: 15px;">
											<input type="button" value="글쓰기" style="margin-right: 3px;" onclick="board_review_insert_action();" />
