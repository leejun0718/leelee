			...
			<div class="woocommerce">
				<div class="container">
					<div class="entry-content">
						...
						<div class="jumun-complete-box" style="border: solid 1px #444; text-align: center;">
							<div class="jumun-complete-box-text" style="margin: 50px 0;">
								...
								<p style="line-height: 35px;">
									주문하신 내역은 MY ORDER 페이지에서 확인하실 수 있습니다.
								</p>
							</div>
						</div>
						<div style="text-align: center; margin-top: 30px">
							<button type="submit" name="add-to-cart"
								...
								메인으로 가기&ensp;<i class="zmdi zmdi-arrow-right"></i>
							</button>
						</div>
					</div>
				</div>
