...
<script type="text/javascript">
	...
	function boardReview_update_action() {
		document.form.action = "board_review_update_action.do";
		document.form.method = 'POST';
		document.form.submit();
	
	}
	
	function boardReviewList() {
		document.form.action = 'board_review_list.do';
		document.form.submit();
	}
		...
		<section class="two-columns-section standard-grid-section section-box">
			<div class="container">
				<div class="two-columns-content">
					...
					<p></p>
					<div class="row">
						<h3 style="width: 100%;text-align: center; padding: 20px 0 40px 0;">문의게시판</h3>
							...
							<table class="board" border="1">
					            ...
					            <tbody style="border: solid 1px #b2b2b2;">
					                <tr>
					                    ...
					                    <td>
					                    	${boardReview.reviewNo}
					                    </td>
					                    <th scope="row">
					                    	조회수
					                    </th>
					                    <td>
					                    	<input type="hidden" name="reviewViewCount" value="${boardReview.reviewViewCount}"/>
					                ...
					                <tr>
					                    ...
					                    <td>
					                    	<input type="hidden" name="reviewWriter" value="${boardReview.reviewWriter}"/>
					                ...
					                <tr>
					                    ...
					                    <td>&nbsp;&nbsp;
					                    	<input type="text" name="reviewTitle" value="${boardReview.reviewTitle}"/>
					                    </td>
					                    <th scope="row">
											평점
										</th>
										<td>&nbsp;&nbsp;
											<input type="hidden" name="reviewGrade" value="${boardReview.reviewGrade}"/>
											${boardReview.reviewGrade}										
										</td>
					                </tr>
					                ...
					                <tr>
					                    ...
					                    <td colspan="3" style="height: 300px;text-align: left;"> &nbsp;&nbsp;
					                        <textarea rows="20" cols="160" name="reviewContent">
												${boardReview.reviewContent}
											</textarea>
					                    </td>
					                </tr>
					            </tbody>
								...
								<tr align=center>
									<td align=center colspan="2">
										<div style="text-align: center;padding-bottom: 15px;">
				    						<input type="submit" value="수정완료" onclick="boardReview_update_action();" />
				    						<input type="button" value="목록으로" onclick="boardReviewList();" />
										</div>
									</td>
								</tr>
						</table>
