...
<script type="text/javascript">
	...
	function boardReview_update_form() {
		
			document.boardReview.action = 'board_review_update_form.do';
			document.boardReview.method = 'POST';
			document.boardReview.submit();
		
	}
	
	function boardReview_delete_action() {
		if(window.confirm('삭제하시겠습니까?')){
			document.boardReview.action = 'board_review_delete_action.do';
			document.boardReview.submit();
	...
	function boardReviewList() {
		document.boardReview.action = 'board_review_list.do';
		document.boardReview.submit();
	}
			...
			<div class="container">
				<div class="two-columns-content">
					...
					<div class="row">
						...
						<form id="boardReview" name="boardReview">
							...
							<table class="board" border="1"> 
								...
								<caption style="background-color: #ccc">
									게시글 상세
								</caption>
	 						...
	 						<table width="100%" style="margin-top: 30px;">
	 							<tr align=center>
		 							<td align=center colspan="4">
		 								<div align="right">
											<input type="button" value="목록" onClick="boardReviewList();" style="margin: 0 3px;">&nbsp;
											<input type="button" value="수정" onClick="boardReview_update_form();" style="margin: 0 3px;">&nbsp;
											<input type="button" value="삭제" onClick="boardReview_delete_action();" style="margin: 0 0 0 3px;">
										</div>
		 							</td>
	 							</tr>
	 						</table>
