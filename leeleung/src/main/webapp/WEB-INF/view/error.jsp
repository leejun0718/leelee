		...
		<section class="page-not-found" style="background-image: url(images/page-not-found-bg.jpg)">
			<div class="page-detail">
				<div class="page-inner">
					<h2 style="padding-bottom: 10px;">죄송합니다,</h2>
					<h2 style="padding-bottom: 30px;">페이지를 찾을 수 없습니다.</h2>
					<a href="main.do" class="au-btn-white btn-small">메인으로 돌아가기<i class="zmdi zmdi-arrow-right"></i></a>
				</div>
			</div>
		</section>
