...
<script type="text/javascript">
	...
	function boardnotice_modify_form() {
			...
			document.form.action = 'boardnotice_modify_form.do';
	...
	function boardnotice_delete_action() {
		if(window.confirm('삭제하시겠습니까?')){
			document.form.action = 'boardnotice_delete_action.do';
			document.form.method = 'POST';
			document.form.submit();
	 						...
	 						<table width="100%" style="margin-top: 30px;">
	 							<tr align=center>
		 							<td align=center colspan="4">
		 								<div align="right">
											<input type="button" value="목록" onClick="boardNoticeList();" style="margin: 0 3px;">&nbsp;
											<input type="button" value="수정" onClick="boardnotice_modify_form();" style="margin: 0 3px;">&nbsp;
											<input type="button" value="삭제" onClick="boardnotice_delete_action();" style="margin: 0 0 0 3px;">
										</div>
		 							</td>
	 							</tr>
	 						</table>
