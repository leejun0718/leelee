...
public class PageMakerOutput {
	private List<BoardNotice> list; 		// 리스트 데이터 콜렉션
	...
	public PageMakerOutput(List<BoardNotice> list, int startPageNo, int endPageNo, int selectPageNo,
	...
	public List<BoardNotice> getList() {
		return list;
	}

	public void setList(List<BoardNotice> list) {
		this.list = list;
	}
