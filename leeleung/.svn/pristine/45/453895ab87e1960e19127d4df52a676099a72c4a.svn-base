									...
									<div class="woocommerce-billing-fields">
										...
										<div class="woocommerce-billing-fields__field-wrapper">
											...
											<p class="form-row-wide">
												<input type="text" class="input-text "
													name="billing_last_name" id="billing_last_name"
													placeholder="결제방법   :     ${sjumun.jumunPay}" readonly>
											</p>
										</div>
									</div>
								</form>
									...
									<div class="woocommerce-billing-fields">
										...
										<div class="woocommerce-billing-fields__field-wrapper">
											<p class="form-row-wide">
												<input type="text" class="input-text "
													name="billing_last_name" id="billing_last_name"
													placeholder="이름   :     ${sjumun.productRec}" readonly>
											</p>
											<p class="form-row-first">
												<input type="text" class="input-text "
													id="billing_first_name" name="zip" placeholder="우편번호   :     ${sjumun.postCode}"
													readonly>
											</p>
											...
											<p class="form-row-wide">
												<input type="text" class="input-text " name="addr1"
													id="billing_address_2" placeholder="주소   :     ${sjumun.jumunAddress}" readonly>
											</p>
											<p class="form-row-wide">
												<input type="text" class="input-text " name="addr2"
													id="billing_address_2" placeholder="상세주소   :     ${sjumun.jumunAddress2}" readonly>
											</p>
											<p class="form-row-first">
												<input type="tel" class="input-text " name="billing_phone"
													id="billing_phone" placeholder="연락처   :     ${sjumun.productRecPhone}" readonly>
											</p>
											<p class="form-row-last">
												<input type="email" class="input-text " name="billing_email"
													id="billing_email" placeholder="Email   :     ${sjumun.jumunEmail}" readonly>
											</p>
										</div>
									</div>
										...
										<div class="woocommerce-additional-fields__field-wrapper">
											<p class="notes" id="order_comments_field">
												<textarea name="order_comments" class="input-text "
													id="order_comments" placeholder="${sjumun.jumunReq}" readonly></textarea>
											</p>
										</div>
									</div>
								</form>
								...
								<div class="woocommerce-checkout-review-order">
									...
									<table class="shop_table" style="clear: both;">
										...
										<p style="padding: 10px 0;">
											...
											<form action="jumun_insert_action.do" method="post">
