...
@Repository("guestDao")
public class GuestDaoImplAnnotation implements GuestDao {
	@Autowired
	private DataSource dataSource;
	public GuestDaoImplAnnotation() throws Exception {
		System.out.println("1.### GuestDaoImpl()생성");
	}
	/*
	public void setDataSource(DataSource dataSource) {
		System.out.println("2.### GuestDaoImpl: setDataSource("+dataSource+")메쏘드호출");
	...
	*/
	 ...
	 */
	/* (non-Javadoc)
	 * @see com.itwill.guest.GuestDao#deleteGuest(int)
	 */
	@Override
